...
| WoWmapperX 1.1.0 x86 NativeAOT | Legacy Windows controller mapper bundled at setup time | MIT; notice retained at `Controller/WoWmapperX/LICENSE.txt` |
...
The same setup script downloads WoWmapperX 1.1.0's official
`wowmapperx-x86-aot.zip` asset and accepts only SHA-256
`a7b60153416584fd52ff2d465cdf35f13c13554bf197e7f0edb7a1542fe676ef`.
WoWmapperX is archived and deprecated upstream in favor of WoWpadX. Soulforge
includes it only as an explicitly launched legacy Windows controller option,
does not run it automatically, and preserves its MIT notice in the generated
pack. Its executable archive remains ignored runtime data rather than a tracked
repository file.
